...
export default function Page() {
 ...
 const phrases = [
  "No 🙈",
  "Are you sureee? 🥺",
  "What if Pratikshya asks really nicely? 💕",
  "Pretty pleaseee 🌸",
  "With extra love on top 💖",
  "What about a chocolate just for you, Avishek? 🍫",
  "Avishekaa please 🥹",
  ...
  "Okay… last try from Pratikshya 😅💗",
  "✨ Now you CAN’T say No to me, Avishek! 💖🥰",
];
    ...
    <div className="-mt-16 flex h-screen flex-col items-center justify-center relative">
      {yesPressed ? (
        <>
          ...
          🎉 YAYYYY!!! I ❤️ YOU, Avishek!! 🎀
          <br />
          Pratikshya is floating on cloud nine ☁️💞
        </div>
        ...
        <>
          ...
          <h1 className="my-4 text-4xl text-center text-pink-400 font-bold animate-pulse">
            💞 Avishek… will you be my Valentine? 🥰
          </h1>
